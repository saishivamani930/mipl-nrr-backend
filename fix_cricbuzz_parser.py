...
backup = Path("ipl_api/espn_standings.py.bak_fix_syntax")
backup.write_text(text, encoding="utf-8")

new_func = '''def fetch_cricbuzz_points_table(season: int) -> Optional[Dict[str, Any]]:
    """
...
print("Fixed Cricbuzz parser syntax")
